...
public class AbonnementFormController implements SeasonObserver {
    ...
    public void fillForm() {
        ...
        if (this.model != null) {
            ...
            this.saison.setDisable(abonnementStatus != AbonnementStatus.NEW);
            this.bloc.setDisable(abonnementStatus != AbonnementStatus.NEW);
            this.rang.setEditable(abonnementStatus == AbonnementStatus.NEW);
            this.place.setEditable(abonnementStatus == AbonnementStatus.NEW);
