...
public class Abonnement implements Serializable {
    ...
    public void setPersonne(final Personne personne) {
        ...
        this.changeSupport.firePropertyChange("personne", oldValue,
                this.personne);
    }
    ...
    public void setReduction(final long reduction) {
        ...
        this.changeSupport.firePropertyChange("reduction", oldValue,
                this.reduction);
    }
    ...
    public void setAcompte(final BigInteger acompte) {
        ...
        this.changeSupport
                .firePropertyChange("acompte", oldValue, this.acompte);
    }
    ...
    public void setPlaceCommandee(final boolean placeCommandee) {
        ...
        this.changeSupport.firePropertyChange("placeCommandee", oldValue,
                this.placeCommandee);
    }
