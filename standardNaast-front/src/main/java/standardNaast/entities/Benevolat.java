...
public class Benevolat implements Serializable {
	...
	public void setDateBenevolat(final Date dateBenevolat) {
		...
		this.changeSupport.firePropertyChange("dateBenevolat",
				oldDateBenevolat, this.dateBenevolat);
	}
	...
	public void setTypeBenevolat(final String typeBenevolat) {
		...
		this.changeSupport.firePropertyChange("typeBenevolat",
				oldTypeBenevolat, this.typeBenevolat);
	}
	...
	public void setPersonne(final Personne personne) {
		...
		this.changeSupport.firePropertyChange("personne", oldPersonne,
				this.personne);
	}
