...
public class TableauCotisations {// extends PdfPageEventHelper {
	...
	// }
	//
	// public static void writeCotisation(final PdfPTable table, final String
	// value) {
	// com.itextpdf.text.Font comic12 = FontFactory.getFont(
	...
	// // Date advantageDate = new DateTime(TableauCotisations.YEAR, 4, 1, 0,
	// // 0)
	// // .toDate();
	// // List<Saison> seasonList = this.getSeasons();
	// // List<Personne> personList = this.getMembers();
	// // List<PersonneCotisation> personCotisationList = new
	// // ArrayList<TableauCotisations.PersonneCotisation>();
	// // Date today = new Date();
	...
	// // // Si l'année de la date d'aujourd'hui et égale à l'année de la
	// // première
	...
	// // if (memberCotisation.getCotisation().getAnneeCotisation2() ==
	// // todayYear) {
	...
	// this.getPersonneService().findAllPerson();
