 ...
 *
 * @author BuyWay-Services: DWW<BR> Created on 12 juin 2012
 */
public abstract class AbstractRuntimeException extends RuntimeException {
     ...
     * The LOG.
     */
    private static final Logger LOG = Logger.getLogger(AbstractRuntimeException.class);
    /**
     * The uniqueId.
     */
    ...
    /**
     * @param message The message to prefix with the unique ID and business ID.
